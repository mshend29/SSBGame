export const DEFAULT_SESSION_CODE = 'SSB2026'

export const budgetOptions = [
  { key: 'food', label: 'Makan', icon: '🍚', options: [600000, 900000, 1200000] },
  { key: 'transport', label: 'Transportasi', icon: '🛵', options: [150000, 300000, 500000] },
  { key: 'internet', label: 'Internet & Pulsa', icon: '📱', options: [100000, 150000, 250000] },
  { key: 'academic', label: 'Keperluan Kuliah', icon: '📚', options: [150000, 250000, 400000] },
  { key: 'lifestyle', label: 'Nongkrong & Hiburan', icon: '☕', options: [100000, 250000, 500000] },
  { key: 'emergency', label: 'Dana Darurat', icon: '🛡️', options: [100000, 300000, 500000] }
]
